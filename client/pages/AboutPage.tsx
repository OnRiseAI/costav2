      ...
      <section className="py-20 md:py-24 bg-blue-50">
        <div className="container-custom text-center max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link to="/search">
              <Button size="lg" variant="outline" className="w-full sm:w-auto border-2 border-[#0a1f44] text-[#0a1f44] hover:bg-blue-50 px-8 py-6 text-lg rounded-full font-bold">
                Browse Tradespeople
              </Button>
            </Link>
          </div>
