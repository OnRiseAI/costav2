...
import { ArrowRight, Clock, Calendar, ChevronRight, Sparkles, Search } from "lucide-react";
      ...
      <section className="relative py-24 lg:py-32 px-4 text-center overflow-hidden bg-[#0a1f44] text-white">
        ...
        <div className="container-custom max-w-4xl relative z-10 mx-auto">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 backdrop-blur-md mb-8 animate-fade-in">
            ...
            <span className="text-sm font-medium tracking-wide uppercase text-blue-100/90">Costa del Sol Living</span>
          </div>
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-8 tracking-tight leading-[1.1]">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-200 to-white">Homeowners</span>
          </h1>
          <p className="text-xl text-blue-100/80 mb-10 font-light max-w-2xl mx-auto leading-relaxed">
            Your trusted resource for renovations, maintenance, legal updates, and local insights in Southern Spain.
          </p>
          ...
          <div className="max-w-md mx-auto relative group">
            ...
            <div className="relative bg-white/10 backdrop-blur-xl border border-white/20 rounded-full p-2 flex items-center">
              ...
              />
              <Button size="sm" className="rounded-full bg-blue-500 hover:bg-blue-400 text-white border-none">
                Search
              </Button>
            </div>
          </div>
      ...
      <div className="container-custom max-w-7xl mx-auto px-4 py-16 -mt-20 relative z-20">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10">
          {recentPosts.map((post) => (
            <Link to={`/blog/${post.slug}`} key={post.id} className="group flex flex-col bg-white rounded-[2rem] border border-slate-100 overflow-hidden hover:shadow-2xl hover:shadow-slate-200/50 transition-all duration-500 hover:-translate-y-2">
              ...
              <div className="p-8 flex-1 flex flex-col">
                <div className="flex items-center gap-3 text-xs font-medium text-slate-400 mb-4">
                  <span className="flex items-center gap-1"><Calendar className="w-3.5 h-3.5" /> Nov 15, 2025</span>
                  <span className="w-1 h-1 bg-slate-300 rounded-full"></span>
        ...
        <div className="mt-20 text-center">
          <Button variant="outline" size="lg" className="px-10 py-6 rounded-full border-slate-200 text-slate-600 hover:text-[#0a1f44] hover:border-[#0a1f44] hover:bg-white text-lg font-medium transition-all duration-300">
            Load More Articles
          </Button>
        </div>
      </div>
