...
export default function VerificationPromisePage() {
  ...
  const testimonials = [
    {
      quote: "I only list my business on platforms where my reputation is protected. CostaTrades gets it right.",
      author: "Local Electrician",
      location: "Marbella, Spain",
      image: "https://images.pexels.com/photos/33531823/pexels-photo-33531823.jpeg"
    },
    {
      quote: "Since joining, I've stopped wasting time on tire-kickers. The leads here are serious.",
      author: "Plumber",
      location: "Estepona, Spain",
      image: "https://images.pexels.com/photos/7220892/pexels-photo-7220892.jpeg"
    },
    {
      quote: "Finally, a directory that actually verifies who we are. It keeps the cowboys out.",
      author: "Builder",
      location: "Mijas, Spain",
      image: "https://images.pexels.com/photos/33497138/pexels-photo-33497138.jpeg"
    }
  ];
    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <section className="relative py-20 md:py-32 overflow-hidden bg-[#0a1f44] text-white">
        ...
        <div className="container-custom relative z-10 text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-blue-100 font-light leading-relaxed max-w-3xl mx-auto animate-slide-up" style={{ animationDelay: "0.1s" }}>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-blue-300">{testimonials[currentTestimonial].location}</p>
                      </div>
                    </div>
                  </motion.div>
                </AnimatePresence>
                ...
                {testimonials.map((_, index) => (
                  <button
                    ...
                    className={cn(
                      ...
                      currentTestimonial === index ? "w-8 bg-blue-400" : "bg-white/20 hover:bg-white/40"
                    )}
                  />
                ))}
              </div>
