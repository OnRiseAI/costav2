      ...
      <div className="flex flex-col min-h-screen">
        ...
        <main className="flex-1">
          <Routes>
            ...
            {/* Information Pages */}
            <Route path="/how-it-works" element={<PlaceholderPage title="How It Works" description="Learn how CostaTrade connects you with trusted professionals" />} />
            ...
            {/* Legal */}
            <Route path="/terms" element={<PlaceholderPage title="Terms of Service" description="Terms and conditions for using CostaTrade" />} />
            ...
            <Route path="/download-app" element={<PlaceholderPage title="Download App" description="Get the CostaTrade app on iOS and Android" />} />
