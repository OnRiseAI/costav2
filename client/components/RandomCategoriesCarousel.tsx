import { Droplets, Wind, Wrench, Zap, Hammer, PaintBucket, Key, Leaf } from 'lucide-react';
              ...
              >
                <div className="relative w-48 h-56 md:w-56 md:h-64 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500">
                  ...
                  <div className="absolute inset-0 flex flex-col justify-end p-4">
                    <h3 className="text-lg md:text-xl font-bold text-white drop-shadow-lg mb-2">{category.name}</h3>
                    <p className="text-sm text-white/90 drop-shadow-lg">{category.count} professionals</p>
                  </div>
                </div>
              </Link>
            ))}
