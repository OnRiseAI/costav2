        ...
        <div className="container-custom">
          <div className="grid md:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="bg-gradient-to-br from-primary via-primary-600 to-primary-700 text-white rounded-2xl p-8 md:p-10 shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105 relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <p className="text-primary-foreground/90 text-sm md:text-base mb-6 leading-relaxed">
                  Get expert tips, special offers, and local tradespeople updates delivered to your inbox
                </p>
            ...
            <div className="bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 text-white rounded-2xl p-8 md:p-10 shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105 relative overflow-hidden group">
              ...
              <div className="relative z-10">
                <h3 className="text-2xl md:text-3xl font-bold mb-3">Need a Tradesperson?</h3>
                <p className="text-blue-100 text-sm md:text-base mb-6 leading-relaxed">
                  Find rated professionals and get quotes for your next project in minutes
                </p>
                <Link to="/search">
            ...
            <div className="bg-gradient-to-br from-orange-500 via-orange-600 to-orange-700 text-white rounded-2xl p-8 md:p-10 shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105 relative overflow-hidden group">
              ...
              <div className="relative z-10">
                <h3 className="text-2xl md:text-3xl font-bold mb-3">Are You a Tradesperson?</h3>
                <p className="text-orange-50 text-sm md:text-base mb-6 leading-relaxed">
                  Join our community and get verified to connect with customers looking for your services
                </p>
      ...
      <div className="bg-white py-16 md:py-20 border-b border-gray-200">
        <div className="container-custom">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
            ...
            <div className="col-span-2 md:col-span-1">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <span className="text-sm text-muted-foreground">Costa del Sol, Spain</span>
                </div>
                <div className="flex items-start gap-3">
                  <Phone className="h-4 w-4 text-primary mt-0.5 flex-shrink-0" />
                  <a href="tel:+34952123456" className="text-sm text-muted-foreground hover:text-primary transition-colors">+34 952 123 456</a>
                </div>
                <div className="flex items-start gap-3">
                  <Mail className="h-4 w-4 text-primary mt-0.5 flex-shrink-0" />
                  <a href="mailto:info@tradefinder.es" className="text-sm text-muted-foreground hover:text-primary transition-colors">info@tradefinder.es</a>
                </div>
              </div>
            </div>
            ...
            {/* For Tradespeople */}
            <div>
              <h4 className="font-bold text-foreground mb-5 text-sm uppercase tracking-wider">For Tradespeople</h4>
              <ul className="space-y-3">
                <li>
                  <Link to="/join-as-tradesperson" className="text-sm text-muted-foreground hover:text-primary transition-colors flex items-center gap-2 group">
                    <span className="inline-block w-1.5 h-1.5 bg-primary rounded-full opacity-0 group-hover:opacity-100 transition-opacity"></span>
                    Join Our Community
                  </Link>
                </li>
                <li>
                  <Link to="/pro/dashboard" className="text-sm text-muted-foreground hover:text-primary transition-colors flex items-center gap-2 group">
                    <span className="inline-block w-1.5 h-1.5 bg-primary rounded-full opacity-0 group-hover:opacity-100 transition-opacity"></span>
                    Dashboard
                  </Link>
                </li>
                <li>
                  <Link to="/pro/leads" className="text-sm text-muted-foreground hover:text-primary transition-colors flex items-center gap-2 group">
                    <span className="inline-block w-1.5 h-1.5 bg-primary rounded-full opacity-0 group-hover:opacity-100 transition-opacity"></span>
                    Get Jobs
                  </Link>
                </li>
                <li>
                  <Link to="/pro/profile" className="text-sm text-muted-foreground hover:text-primary transition-colors flex items-center gap-2 group">
                    <span className="inline-block w-1.5 h-1.5 bg-primary rounded-full opacity-0 group-hover:opacity-100 transition-opacity"></span>
                    My Profile
                  </Link>
                </li>
                <li>
                  <Link to="/pro/help" className="text-sm text-muted-foreground hover:text-primary transition-colors flex items-center gap-2 group">
                    <span className="inline-block w-1.5 h-1.5 bg-primary rounded-full opacity-0 group-hover:opacity-100 transition-opacity"></span>
                    Support
                  </Link>
                </li>
            ...
            {/* Popular Trades */}
            <div>
              <h4 className="font-bold text-foreground mb-5 text-sm uppercase tracking-wider">Popular Trades</h4>
              <ul className="space-y-3">
            ...
            {/* Legal */}
            <div>
              <h4 className="font-bold text-foreground mb-5 text-sm uppercase tracking-wider">Legal</h4>
              <ul className="space-y-3">
                <li>
                ...
                <li>
                  <Link to="/cookies" className="text-sm text-muted-foreground hover:text-primary transition-colors flex items-center gap-2 group">
                    <span className="inline-block w-1.5 h-1.5 bg-primary rounded-full opacity-0 group-hover:opacity-100 transition-opacity"></span>
                    Cookie Policy
                  </Link>
                </li>
          ...
          <div className="border-t border-gray-200 pt-12">
            <div className="grid md:grid-cols-2 gap-12">
              {/* Social Media */}
              <div>
                <h4 className="font-bold text-foreground mb-6 text-sm uppercase tracking-wider">Follow Us</h4>
        ...
        <div className="container-custom">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm">
            ...
            <div className="flex items-center gap-6 text-gray-400">
              ...
              <a href="#" className="hover:text-white transition-colors text-xs">Report a Bug</a>
            </div>
          </div>
        </div>
      </div>
