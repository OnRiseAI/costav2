    ...
    <div className="bg-gray-50 py-16 md:py-20 relative overflow-hidden">
      ...
      <div className="relative z-10">
        <div className="container-custom flex items-center justify-between mb-8">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold mb-2">Recommended jobs</h2>
            <p className="text-muted-foreground">Find verified professionals for popular services</p>
          </div>
                ...
                >
                  ...
                  <div className="relative z-10">
                    <div className="flex items-start justify-between mb-4">
                      <span className={`inline-block ${colors.bg} ${colors.text} px-3 py-1 rounded-full text-xs font-semibold uppercase tracking-wide`}>
                        {job.tag}
                      </span>
                    ...
                    <h3 className="text-lg font-bold mb-2 pr-6 group-hover:text-primary transition-colors">{job.title}</h3>
                    ...
                    {job.rating && job.reviews && (
                      <div className="flex items-center gap-2 mb-4 pb-4 border-t border-gray-200">
                        ...
                        <span className="text-xs text-muted-foreground font-medium">{job.rating} ({job.reviews})</span>
                      </div>
                    )}
